...
//CSL 추가
  $("body").append("<div id=footer class=center ><h5><small><small>CSL HUSTOJ release 21.02.09</small></small></h5></div>");
  $("body").append("<div id=footer class=center >Supported by CSL "+(new Date()).getFullYear()+" </div>");
